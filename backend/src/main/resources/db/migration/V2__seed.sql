...
INSERT INTO order_item (order_id, product_id, product_name, unit_price, quantity, item_index) VALUES
    (1, 1, 'ノートPC 14インチ', 128000, 2, 0),
    (1, 2, 'ワイヤレスマウス', 2800, 2, 1);
